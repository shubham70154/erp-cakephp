...
<h2>Mostrando Lançamento</h2>
	...
	<dl>
		...
		<dd>&nbsp;<?php echo $html->link(utf8_decode($lancamento['CentroCusto']['nome']), array('controller'=> 'centro_custos', 'action'=>'view', $lancamento['CentroCusto']['id'])); ?></dd>
		<dt>Categoria</dt>
		<dd>&nbsp;<?php echo $html->link(utf8_decode($lancamento['Categoria']['nome']), array('controller'=> 'categorias', 'action'=>'view', $lancamento['Categoria']['id'])); ?></dd>
		<dt>Conta</dt>
		<dd>&nbsp;<?php echo $html->link(utf8_decode($lancamento['Conta']['nome']), array('controller'=> 'contas', 'action'=>'view', $lancamento['Conta']['id'])); ?></dd>
		<dt>Descrição</dt>
		<dd>&nbsp;<?php echo utf8_decode($lancamento['Lancamento']['descricao'])?></dd>
		<dt>Data</dt>
...
<div class="actions">
	<ul>
		...
		<li><?php echo $html->link('Excluir Lançamento', array('action'=>'delete', $lancamento['Lancamento']['id']), null, 'Você tem certeza que deseja excluir o lançamento #' . $lancamento['Lancamento']['id'] . '?'); ?> </li>
