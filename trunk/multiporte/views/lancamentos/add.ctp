...
<div class="actions">
	<ul>
		...
		<li><?php echo $html->link('View Contas', array('controller'=> 'contas', 'action'=>'view'));?></li>
		<li><?php echo $html->link('Add Contas', array('controller'=> 'contas', 'action'=>'add')); ?></li>
		<li><?php echo $html->link('View Categorias', array('controller'=> 'categorias', 'action'=>'view'));?></li>
		<li><?php echo $html->link('Add Categorias', array('controller'=> 'categorias', 'action'=>'add')); ?></li>
	</ul>
</div>
