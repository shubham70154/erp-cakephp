...
<div class="actions">
	<ul>
		<li><?php echo $html->link('Excluir', array('action'=>'delete', $html->tagValue('Categoria/id')), null, 'Você tem certeza que deseja excluir a categoria #' . $html->tagValue('Categoria/id') . '?'); ?>
